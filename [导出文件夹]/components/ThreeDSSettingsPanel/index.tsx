  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.settingsContainer}>
        <div className={styles.notificationChannelSection}>
          <span className={styles.notificationChannelLabel}>通知渠道</span>
          <div className={styles.channelOptionsWrapper}>
            <div className={styles.componentCommonBqr4}>
              <div className={styles.componentSharedSzg0}>
                <div className={styles.smsNotificationIcon}>
                  <TabletOutlined className={styles.notificationChannelIcon} />
                </div>
        ...
        <div className={styles.phoneNumberSection}>
          <div className={styles.phoneNumberContent}>
            <div className={styles.componentSharedCms8}>
              ...
              <div className={styles.phoneNumberSelection}>
                <CheckOutlined className={styles.componentSharedJyo0} />
                <span className={styles.componentSharedJyl8}>
                  卡3DS手机号
                </span>
              </div>
            </div>
          ...
          <div className={styles.updateSecurityInfoSection}>
            <div className={styles.componentSharedCms8}>
              <span className={styles.componentSharedEjz8}>
                更新账户安全手机号/邮箱，是否覆盖卡3DS手机号/邮箱？
              </span>
              <div className={styles.updateSecurityInfoOption}>
                <CheckOutlined className={styles.componentSharedJyo0} />
            ...
            <Button
              shape="round"
              onClick={onEditClick}
              className={styles.updateSecurityInfoButton}
            >
              修改
            </Button>
          </div>
